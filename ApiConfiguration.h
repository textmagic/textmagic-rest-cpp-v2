...
#ifndef COM_TEXTMAGIC_CLIENT_API_ApiConfiguration_H_
#define COM_TEXTMAGIC_CLIENT_API_ApiConfiguration_H_
...
#endif /* COM_TEXTMAGIC_CLIENT_API_ApiConfiguration_H_ */
