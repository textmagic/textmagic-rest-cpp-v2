...
/*
 * UpdateContact_request.h
 *
 * 
 */

#ifndef COM_TEXTMAGIC_CLIENT_MODEL_UpdateContact_request_H_
#define COM_TEXTMAGIC_CLIENT_MODEL_UpdateContact_request_H_
...
class  UpdateContact_request
    : public ModelBase
{
public:
    UpdateContact_request();
    virtual ~UpdateContact_request();
    ...
    std::vector<std::shared_ptr<CustomFieldListItem>> getCustomFieldValues() const;
    bool customFieldValuesIsSet() const;
    void unsetCustomFieldValues();
    void setCustomFieldValues(const std::vector<std::shared_ptr<CustomFieldListItem>>& value);
...
#endif /* COM_TEXTMAGIC_CLIENT_MODEL_UpdateContact_request_H_ */
