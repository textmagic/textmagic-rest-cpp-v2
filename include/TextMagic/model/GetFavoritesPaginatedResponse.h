...
public:
    ...
    std::vector<std::shared_ptr<FavoriteContact>> getResources() const;
    bool resourcesIsSet() const;
    void unsetResources();
    void setResources(const std::vector<std::shared_ptr<FavoriteContact>>& value);
...
protected:
    ...
    std::vector<std::shared_ptr<FavoriteContact>> m_Resources;
