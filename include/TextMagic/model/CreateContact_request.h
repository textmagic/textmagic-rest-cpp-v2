...
/*
 * CreateContact_request.h
 *
 * 
 */

#ifndef COM_TEXTMAGIC_CLIENT_MODEL_CreateContact_request_H_
#define COM_TEXTMAGIC_CLIENT_MODEL_CreateContact_request_H_
...
class  CreateContact_request
    : public ModelBase
{
public:
    CreateContact_request();
    virtual ~CreateContact_request();
...
#endif /* COM_TEXTMAGIC_CLIENT_MODEL_CreateContact_request_H_ */
