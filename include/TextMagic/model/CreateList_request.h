...
/*
 * CreateList_request.h
 *
 * 
 */

#ifndef COM_TEXTMAGIC_CLIENT_MODEL_CreateList_request_H_
#define COM_TEXTMAGIC_CLIENT_MODEL_CreateList_request_H_
...
class  CreateList_request
    : public ModelBase
{
public:
    CreateList_request();
    virtual ~CreateList_request();
...
#endif /* COM_TEXTMAGIC_CLIENT_MODEL_CreateList_request_H_ */
