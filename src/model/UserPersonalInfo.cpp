...
bool UserPersonalInfo::fromJson(const web::json::value& val)
{
    bool ok = true;
...
bool UserPersonalInfo::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(_XPLATSTR(".")))
...
bool UserPersonalInfo::idIsSet() const
{
    return m_IdIsSet;
}

void UserPersonalInfo::unsetId()
{
    m_IdIsSet = false;
}
...
void UserPersonalInfo::setFirstName(const utility::string_t& value)
{
    m_FirstName = value;
...
void UserPersonalInfo::setLastName(const utility::string_t& value)
{
    m_LastName = value;
...
void UserPersonalInfo::setAvatarUrl(const utility::string_t& value)
{
    m_AvatarUrl = value;
...
void UserPersonalInfo::setEmail(const utility::string_t& value)
{
    m_Email = value;
    m_EmailIsSet = true;
}
