...
bool GetListsPaginatedResponse::fromJson(const web::json::value& val)
{
    bool ok = true;
...
bool GetListsPaginatedResponse::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(_XPLATSTR(".")))
...
bool GetListsPaginatedResponse::pageIsSet() const
{
    return m_PageIsSet;
}

void GetListsPaginatedResponse::unsetPage()
{
    m_PageIsSet = false;
}
...
bool GetListsPaginatedResponse::pageCountIsSet() const
{
    return m_PageCountIsSet;
}

void GetListsPaginatedResponse::unsetPageCount()
{
    m_PageCountIsSet = false;
}
...
bool GetListsPaginatedResponse::limitIsSet() const
{
    return m_LimitIsSet;
}

void GetListsPaginatedResponse::unsetLimit()
{
    m_LimitIsSet = false;
}
std::vector<std::shared_ptr<List>> GetListsPaginatedResponse::getResources() const
{
    return m_Resources;
}


void GetListsPaginatedResponse::setResources(const std::vector<std::shared_ptr<List>>& value)
{
    m_Resources = value;
    m_ResourcesIsSet = true;
}

bool GetListsPaginatedResponse::resourcesIsSet() const
{
    return m_ResourcesIsSet;
}

void GetListsPaginatedResponse::unsetResources()
{
    m_ResourcesIsSet = false;
}
