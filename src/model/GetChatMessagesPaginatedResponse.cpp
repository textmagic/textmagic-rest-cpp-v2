...
bool GetChatMessagesPaginatedResponse::fromJson(const web::json::value& val)
{
    bool ok = true;
    ...
    if(val.has_field(utility::conversions::to_string_t(_XPLATSTR("resources"))))
    {
        ...
        if(!fieldValue.is_null())
        {
            std::vector<std::shared_ptr<Conversation>> refVal_setResources;
...
bool GetChatMessagesPaginatedResponse::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(_XPLATSTR(".")))
...
bool GetChatMessagesPaginatedResponse::pageIsSet() const
{
    return m_PageIsSet;
}

void GetChatMessagesPaginatedResponse::unsetPage()
{
    m_PageIsSet = false;
}
...
bool GetChatMessagesPaginatedResponse::pageCountIsSet() const
{
    return m_PageCountIsSet;
}

void GetChatMessagesPaginatedResponse::unsetPageCount()
{
    m_PageCountIsSet = false;
}
...
bool GetChatMessagesPaginatedResponse::limitIsSet() const
{
    return m_LimitIsSet;
}

void GetChatMessagesPaginatedResponse::unsetLimit()
{
    m_LimitIsSet = false;
}
std::vector<std::shared_ptr<Conversation>> GetChatMessagesPaginatedResponse::getResources() const
{
    return m_Resources;
}


void GetChatMessagesPaginatedResponse::setResources(const std::vector<std::shared_ptr<Conversation>>& value)
{
    m_Resources = value;
    m_ResourcesIsSet = true;
}

bool GetChatMessagesPaginatedResponse::resourcesIsSet() const
{
    return m_ResourcesIsSet;
}

void GetChatMessagesPaginatedResponse::unsetResources()
{
    m_ResourcesIsSet = false;
}
