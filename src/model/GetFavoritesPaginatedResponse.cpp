...
bool GetFavoritesPaginatedResponse::fromJson(const web::json::value& val)
{
    bool ok = true;
    ...
    if(val.has_field(utility::conversions::to_string_t(_XPLATSTR("resources"))))
    {
        ...
        if(!fieldValue.is_null())
        {
            std::vector<std::shared_ptr<FavoriteContact>> refVal_setResources;
...
bool GetFavoritesPaginatedResponse::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(_XPLATSTR(".")))
...
bool GetFavoritesPaginatedResponse::pageIsSet() const
{
    return m_PageIsSet;
}

void GetFavoritesPaginatedResponse::unsetPage()
{
    m_PageIsSet = false;
}
...
bool GetFavoritesPaginatedResponse::pageCountIsSet() const
{
    return m_PageCountIsSet;
}

void GetFavoritesPaginatedResponse::unsetPageCount()
{
    m_PageCountIsSet = false;
}
...
bool GetFavoritesPaginatedResponse::limitIsSet() const
{
    return m_LimitIsSet;
}

void GetFavoritesPaginatedResponse::unsetLimit()
{
    m_LimitIsSet = false;
}
std::vector<std::shared_ptr<FavoriteContact>> GetFavoritesPaginatedResponse::getResources() const
{
    return m_Resources;
}


void GetFavoritesPaginatedResponse::setResources(const std::vector<std::shared_ptr<FavoriteContact>>& value)
{
    m_Resources = value;
    m_ResourcesIsSet = true;
}

bool GetFavoritesPaginatedResponse::resourcesIsSet() const
{
    return m_ResourcesIsSet;
}

void GetFavoritesPaginatedResponse::unsetResources()
{
    m_ResourcesIsSet = false;
}
