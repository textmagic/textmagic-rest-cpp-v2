...
bool GetSenderIdsPaginatedResponse::fromJson(const web::json::value& val)
{
    bool ok = true;
    ...
    if(val.has_field(utility::conversions::to_string_t(_XPLATSTR("resources"))))
    {
        ...
        if(!fieldValue.is_null())
        {
            std::vector<std::shared_ptr<SenderId>> refVal_setResources;
...
bool GetSenderIdsPaginatedResponse::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(_XPLATSTR(".")))
...
bool GetSenderIdsPaginatedResponse::pageIsSet() const
{
    return m_PageIsSet;
}

void GetSenderIdsPaginatedResponse::unsetPage()
{
    m_PageIsSet = false;
}
...
bool GetSenderIdsPaginatedResponse::pageCountIsSet() const
{
    return m_PageCountIsSet;
}

void GetSenderIdsPaginatedResponse::unsetPageCount()
{
    m_PageCountIsSet = false;
}
...
bool GetSenderIdsPaginatedResponse::limitIsSet() const
{
    return m_LimitIsSet;
}

void GetSenderIdsPaginatedResponse::unsetLimit()
{
    m_LimitIsSet = false;
}
std::vector<std::shared_ptr<SenderId>> GetSenderIdsPaginatedResponse::getResources() const
{
    return m_Resources;
}


void GetSenderIdsPaginatedResponse::setResources(const std::vector<std::shared_ptr<SenderId>>& value)
{
    m_Resources = value;
    m_ResourcesIsSet = true;
}

bool GetSenderIdsPaginatedResponse::resourcesIsSet() const
{
    return m_ResourcesIsSet;
}

void GetSenderIdsPaginatedResponse::unsetResources()
{
    m_ResourcesIsSet = false;
}
