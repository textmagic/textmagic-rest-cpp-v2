...
utility::string_t UpdateContactInputObject::getTags() const
{
    return m_Tags;
}


void UpdateContactInputObject::setTags(utility::string_t value)
{
    m_Tags = value;
    m_TagsIsSet = true;
}
bool UpdateContactInputObject::tagsIsSet() const
{
    return m_TagsIsSet;
}

void UpdateContactInputObject::unsetTags()
{
    m_TagsIsSet = false;
}

int32_t UpdateContactInputObject::getOwner() const
{
    return m_Owner;
}


void UpdateContactInputObject::setOwner(int32_t value)
{
    m_Owner = value;
    m_OwnerIsSet = true;
}
bool UpdateContactInputObject::ownerIsSet() const
{
    return m_OwnerIsSet;
}

void UpdateContactInputObject::unsetOwner()
{
    m_OwnerIsSet = false;
}
