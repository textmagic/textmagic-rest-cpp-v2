...
void SearchChatsPaginatedResponse::fromJson(web::json::value& val)
{
...
void SearchChatsPaginatedResponse::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t("."))
    {
...
std::vector<std::shared_ptr<Chat>>& SearchChatsPaginatedResponse::getResources()
{
    return m_Resources;
}

void SearchChatsPaginatedResponse::setResources(std::vector<std::shared_ptr<Chat>> value)
{
    m_Resources = value;
