...
void UnmuteChatsBulkInputObject::validate()
{
    // TODO: implement validation
}

web::json::value UnmuteChatsBulkInputObject::toJson() const
{
...
void UnmuteChatsBulkInputObject::fromJson(web::json::value& val)
{
...
void UnmuteChatsBulkInputObject::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
void UnmuteChatsBulkInputObject::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t("."))
    {
...
utility::string_t UnmuteChatsBulkInputObject::getIds() const
{
    return m_Ids;
}


void UnmuteChatsBulkInputObject::setIds(utility::string_t value)
{
    m_Ids = value;
    m_IdsIsSet = true;
}
bool UnmuteChatsBulkInputObject::idsIsSet() const
{
    return m_IdsIsSet;
}

void UnmuteChatsBulkInputObject::unsetIds()
{
    m_IdsIsSet = false;
}

bool UnmuteChatsBulkInputObject::isAll() const
{
    return m_All;
}


void UnmuteChatsBulkInputObject::setAll(bool value)
{
    m_All = value;
    m_AllIsSet = true;
}
bool UnmuteChatsBulkInputObject::allIsSet() const
{
    return m_AllIsSet;
}

void UnmuteChatsBulkInputObject::unsetAll()
{
    m_AllIsSet = false;
}
