...
void DeleteMessageSessionsBulkInputObject::validate()
{
    // TODO: implement validation
}

web::json::value DeleteMessageSessionsBulkInputObject::toJson() const
{
...
void DeleteMessageSessionsBulkInputObject::fromJson(web::json::value& val)
{
...
void DeleteMessageSessionsBulkInputObject::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
void DeleteMessageSessionsBulkInputObject::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t("."))
    {
...
utility::string_t DeleteMessageSessionsBulkInputObject::getIds() const
{
    return m_Ids;
}


void DeleteMessageSessionsBulkInputObject::setIds(utility::string_t value)
{
    m_Ids = value;
    m_IdsIsSet = true;
}
bool DeleteMessageSessionsBulkInputObject::idsIsSet() const
{
    return m_IdsIsSet;
}

void DeleteMessageSessionsBulkInputObject::unsetIds()
{
    m_IdsIsSet = false;
}

int32_t DeleteMessageSessionsBulkInputObject::getAll() const
{
    return m_All;
}


void DeleteMessageSessionsBulkInputObject::setAll(int32_t value)
{
    m_All = value;
    m_AllIsSet = true;
}
bool DeleteMessageSessionsBulkInputObject::allIsSet() const
{
    return m_AllIsSet;
}

void DeleteMessageSessionsBulkInputObject::unsetAll()
{
    m_AllIsSet = false;
}
