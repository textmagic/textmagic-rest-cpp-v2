...
Apiv2emailcampaigns_recipients::Apiv2emailcampaigns_recipients()
{
}
...
void Apiv2emailcampaigns_recipients::validate()
{
    // TODO: implement validation
}

web::json::value Apiv2emailcampaigns_recipients::toJson() const
{
...
void Apiv2emailcampaigns_recipients::fromJson(web::json::value& val)
{
    {
        m_ContactIds.clear();
        std::vector<web::json::value> jsonArray;
...
void Apiv2emailcampaigns_recipients::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
void Apiv2emailcampaigns_recipients::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t("."))
    {
...
std::vector<int32_t>& Apiv2emailcampaigns_recipients::getContactIds()
{
    return m_ContactIds;
}

void Apiv2emailcampaigns_recipients::setContactIds(std::vector<int32_t> value)
{
    m_ContactIds = value;
    
}
std::vector<utility::string_t>& Apiv2emailcampaigns_recipients::getEmails()
{
    return m_Emails;
}

void Apiv2emailcampaigns_recipients::setEmails(std::vector<utility::string_t> value)
{
    m_Emails = value;
    
}
std::vector<int32_t>& Apiv2emailcampaigns_recipients::getGroupIds()
{
    return m_GroupIds;
}

void Apiv2emailcampaigns_recipients::setGroupIds(std::vector<int32_t> value)
{
    m_GroupIds = value;
