...
void GetContactsPaginatedResponse::fromJson(web::json::value& val)
{
...
void GetContactsPaginatedResponse::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t("."))
    {
...
std::vector<std::shared_ptr<Contact>>& GetContactsPaginatedResponse::getResources()
{
    return m_Resources;
}

void GetContactsPaginatedResponse::setResources(std::vector<std::shared_ptr<Contact>> value)
{
    m_Resources = value;
