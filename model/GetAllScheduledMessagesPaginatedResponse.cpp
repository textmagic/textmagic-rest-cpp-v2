...
void GetAllScheduledMessagesPaginatedResponse::fromJson(web::json::value& val)
{
...
void GetAllScheduledMessagesPaginatedResponse::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t("."))
    {
...
std::vector<std::shared_ptr<MessagesIcs>>& GetAllScheduledMessagesPaginatedResponse::getResources()
{
    return m_Resources;
}

void GetAllScheduledMessagesPaginatedResponse::setResources(std::vector<std::shared_ptr<MessagesIcs>> value)
{
    m_Resources = value;
