...
void SearchContactsPaginatedResponse::fromJson(web::json::value& val)
{
...
void SearchContactsPaginatedResponse::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t("."))
    {
...
std::vector<std::shared_ptr<Contact>>& SearchContactsPaginatedResponse::getResources()
{
    return m_Resources;
}

void SearchContactsPaginatedResponse::setResources(std::vector<std::shared_ptr<Contact>> value)
{
    m_Resources = value;
