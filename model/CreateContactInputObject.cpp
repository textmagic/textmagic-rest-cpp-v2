...
bool CreateContactInputObject::phoneIsSet() const
{
    return m_PhoneIsSet;
}

void CreateContactInputObject::unsetPhone()
{
    m_PhoneIsSet = false;
}
...
bool CreateContactInputObject::listsIsSet() const
{
    return m_ListsIsSet;
}

void CreateContactInputObject::unsetLists()
{
    m_ListsIsSet = false;
}
