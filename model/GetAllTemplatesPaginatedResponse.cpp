...
void GetAllTemplatesPaginatedResponse::fromJson(web::json::value& val)
{
...
void GetAllTemplatesPaginatedResponse::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t("."))
    {
...
std::vector<std::shared_ptr<MessageTemplate>>& GetAllTemplatesPaginatedResponse::getResources()
{
    return m_Resources;
}

void GetAllTemplatesPaginatedResponse::setResources(std::vector<std::shared_ptr<MessageTemplate>> value)
{
    m_Resources = value;
